        ...
        <Parallax className='image2' bgImage={secondBG} strength={800}>
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4" id="theCards">
                            <div className="col"> 
                                ...
                                <Card.Img project="Testing" src="https://lorempokemon.fakerapi.it/pokemon/400/110"/>
                                        <div className="card-body text-center">
                                            <h5 className="card-title">"Not a test"</h5>
                                            <p className="card-text">"Or is it?"</p>
                                            <div className='d-flex text-center justify-content-center'>
                                            < a href="test2" className='underline'>
                                                <img src={urlBadge} alt="names"/>
                                                <p>Website</p>
                                            </a>
                                            
                                            < a href="test3" className='underline'>
